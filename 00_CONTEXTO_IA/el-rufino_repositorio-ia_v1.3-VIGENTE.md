...
### Cambios v1.3: plugin actualizado a v8.1.2 · arquitectura rediseñada en 4 pantallas · 12 agentes · Kanban + Importador demo · checklist Fase 2 verificado desde panel real · entorno prueba.infoconectados.com documentado · API key OpenRouter revocada y renovada · limpieza carpeta Descargas ejecutada · semáforos actualizados
...
## SECCIÓN 2 — ARQUITECTURA TÉCNICA REAL (v1.3)
...
**Archivo disponible:** `F:\downloads\Viejos\el-rufino-panel-v8.1.2.zip`
...
| 12 | (nuevo en v8) | Por confirmar |

### 2.4 Archivos del proyecto disponibles localmente

**Ruta base:** `F:\HERRAMIENTAS DE IA\CLAUDE\EL RUFINO\`  
**Archivos críticos en `F:\downloads\Viejos\`:**

| Archivo | Relevancia |
|---|---|
| `el-rufino-panel-v8.1.2.zip` | Plugin más reciente · pendiente instalar en producción |
| `el-rufino-child-v1.1.zip` | Child theme Newsup · pendiente instalar |
| `style.css + functions.php + customizer-preview.js` | Archivos sueltos del child theme |
| `el-rufino_rankmath.php` | Configuración SEO Rank Math |
| `el-rufino_setup.php` | Script de setup inicial |
| `Imagenes El Rufino/` | Logos (negro/blanco/transparente) + favicon + OG images |
| `panel.html + panel.jsx + panel.css` | Fuentes del panel v8 |
| `api-proxy.php` | Proxy para Claude API |
| `AUDITORIA_EL-RUFINO_2026-04-08.md` | Auditoría técnica anterior |
| `el-rufino_dossier-fundacional.pdf` | Documento institucional |

### 2.5 Checklist WordPress — estado actual
...
| Child theme Newsup | AMARILLO | Archivo disponible en Viejos/ · falta instalar |
