...
## ARQUITECTURA TECNICA ACTUAL (v8.6.0)
...
- Produccion — tools de contenido
- Inteligencia — agentes IA
- Seguimiento — Kanban + Promesas + exportar CSV
- Asistente — asistente de noticia con YouTube + imagen + transcripcion automatica via captions
...
|---|---|---|
| EL_RUFINO | 730 | ACTIVO · documentado v1.6 |
...
| Ejecutar limpieza escritorio (script) | Pendiente · mover contrasenas primero |
