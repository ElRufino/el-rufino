...
## Usar: el-rufino_repositorio-ia_v1.6-VIGENTE.md
...
### Cambios v1.6: plugin actualizado a v8.6.0 · 5 pantallas (Dashboard / Produccion / Inteligencia / Seguimiento / Asistente) · categorías P01-P06 marcadas como completadas · entorno actualizado a elrufino.com.ar (producción activa) · referencias cruzadas actualizadas a v1.6
...
ENTORNO_TEST = prueba.infoconectados.com (ACTIVO · plugin v8.6.0 instalado)
...
PLUGIN_PANTALLAS = Dashboard / Producción / Inteligencia / Seguimiento / Asistente
TEMA_PADRE = Newsup
FASE_ACTUAL = Fase 2 · producto mínimo · 40% completado
FASE_1 = identidad cerrada (COMPLETADA)
CHECKLIST_OK = Logo/favicon/OG subidos · 20 notas publicadas · 6 categorías P01-P06 creadas
CHECKLIST_PENDIENTE = Schema NewsMediaOrganization · 500 WA suscriptores · child theme paleta B · elrufino.ar NIC
...
ARCHIVO_CONTEXTO = 00_CONTEXTO_IA/usina-de-ideas_repositorio-ia_v1.6-VIGENTE.md
ARCHIVO_AGENTES = 00_CONTEXTO_IA/usina-de-ideas_agentes-ia_v1.6-VIGENTE.md
...
## SECCIÓN 2 — ARQUITECTURA TÉCNICA REAL (v1.6)
...
| prueba.infoconectados.com | Entorno de test | ACTIVO · plugin v8.6.0 instalado |
| elrufino.infoconectados.com.ar | Entorno anterior | OBSOLETO · no usar |

### 2.2 Plugin v8.6.0 — "El Rufino — Panel IA"

**Instalación activa:** elrufino.com.ar (producción)
**Entorno test:** prueba.infoconectados.com
**Archivo disponible:** `F:\HERRAMIENTAS DE IA\PROYECTOS\EL_RUFINO\02_WORDPRESS_TEST\el-rufino-panel-v8.6.0.zip`

#### Estructura de pantallas (5 pantallas)
...
| 6 categorías P01-P06 creadas | ✅ OK |
| Schema NewsMediaOrganization | ❌ Pendiente |
| 500 suscriptores WhatsApp | ❌ Pendiente |
| Child theme Newsup con paleta B | ❌ Pendiente |
| elrufino.ar registrado en NIC | ❌ Pendiente |

**Fase 2: 40% completado**

### 2.3 Sistema de agentes (12 agentes en v8.6.0)

| # | Agente | Tipo | Estado |
|---|---|---|---|
| 1 | SEO | Operativo | activo |
| 2 | Arquitectura | Operativo | activo |
| 3 | Tema Visual | Operativo | activo |
| 4 | Planificador | Operativo | activo |
| 5 | Redactor | Operativo | activo |
| 6 | TikTok / Reel | Operativo | activo |
| 7 | Accountability | Operativo | activo |
| 8 | Stack | Técnico | activo |
| 9 | Servidor | Técnico | activo |
| 10 | Agenda de Datos | Contenido | activo |
| 11 | Imágenes | Contenido | activo |
...
EL_RUFINO\
├── 🔴 00_CONTEXTO_IA\
│   ├── usina-de-ideas_agentes-ia_v1.6-VIGENTE.md
│   ├── usina-de-ideas_prompt-maestro_v1.6-VIGENTE.md
│   └── usina-de-ideas_repositorio-ia_v1.6-VIGENTE.md       este archivo
...
├── ⚪ _ACTIVO\
├── ⚪ _ARCHIVO\
└── .git                                    repo git · sincronizado origin/main
```
...
- [x] Plugin v8.6.0 activo en elrufino.com.ar (producción)
...
- [x] Categorías y slugs P01-P06 creados
...
| Color | Hex | Uso |
|---|---|---|
| Rojo | #c0271b | Cabecera, acentos, masthead |
...
| Repo git | VERDE | Consolidado en EL_RUFINO\ · sincronizado origin/main |
...
| Child theme Newsup | AMARILLO | Archivo disponible en _ACTIVO\ · falta instalar |
...
7. **Regla de sincronización:** al versionar cualquier archivo de 00_CONTEXTO_IA, actualizar las referencias cruzadas en prompt-maestro en la misma operación. Nunca versionar un archivo de contexto sin versionar el prompt-maestro en la misma sesión.
...
*Versión 1.6 · 12 de mayo de 2026*
*Sincronizado con: usina-de-ideas_prompt-maestro_v1.6-VIGENTE.md · usina-de-ideas_agentes-ia_v1.6-VIGENTE.md*
